...
This is my submission for assignment for the Programming C++ for Engineers using Arduino course at GHANA COMMUNICATION TECHNOLOGY UNIVERSITY. So in this poject, a 7-segment display counts down from 9 to 0. On each step, a passive
